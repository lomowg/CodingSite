    ...
    4508: (e,t,n)=>{
        ...
        class IconsManager {
            ...
            createSvgNode(e, t) {
                ...
                return Object.keys(n).map((e=>s[e] = n[e])),
    ...
    3896: (e,t,n)=>{
        ...
        e.exports = elementorModules.ViewModule.extend({
            ...
            showModal(e) {
                ...
                const s = t.getModal();
                switch (s.setID(t.getSettings("modalOptions.id")),
                s.onShow = function() {
                    DialogsManager.getWidgetType("lightbox").prototype.onShow.apply(s, arguments),
                    t.setEntranceAnimation()
                }
                ,
                s.onHide = function() {
                    DialogsManager.getWidgetType("lightbox").prototype.onHide.apply(s, arguments),
            ...
            createShareLink(e, t) {
                ...
                const i = {};
                return "pinterest" === e ? i.image = encodeURIComponent(t) : i.url = encodeURIComponent(location.href.replace(/#.*/, "") + n),
            ...
            getSlideshowHeader() {
                ...
                if (n || i || o || r) {
                    ...
                    if (o) {
                        ...
                        i.push(d.$iconZoom),
                        this.isFontIconSvgExperiment && (d.$iconZoomOut = t(s.zoomOutBold.element).attr(o).addClass(l.hidden).on("click", this.toggleZoomMode),
                    ...
                    if (i) {
                        ...
                        d.$iconExpand = t(n).append(t("<span>"), t("<span>")).attr(r).on("click", this.toggleFullscreen),
                        i.push(d.$iconExpand),
                        this.isFontIconSvgExperiment && (d.$iconMinimize = t(s.frameMinimize.element).attr(o).addClass(l.hidden).on("click", this.toggleFullscreen),
            ...
            activateZoom() {
                ...
                this.isFontIconSvgExperiment ? (t.$iconZoom.addClass(n.hidden).attr("aria-checked", "false"),
                t.$iconZoomOut.removeClass(n.hidden).attr("aria-checked", "true")) : t.$iconZoom.removeClass(n.slideshow.iconZoomIn).addClass(n.slideshow.iconZoomOut)
            },
            deactivateZoom() {
                const e = this.swiper
                  , t = this.elements
                ...
                this.isFontIconSvgExperiment ? (t.$iconZoom.removeClass(n.hidden).attr("aria-checked", "true"),
                t.$iconZoomOut.addClass(n.hidden).attr("aria-checked", "false")) : t.$iconZoom.removeClass(n.slideshow.iconZoomOut).addClass(n.slideshow.iconZoomIn)
            },
            getSlideshowFooter() {
                const e = jQuery
            ...
            setSlideshowContent(e) {
                ...
                if (e.slides.forEach((e=>{
                    ...
                    if (e.video) {
                        ...
                        e.title && (s["data-title"] = e.title,
                        s.alt = e.title),
                        e.description && (s["data-description"] = e.description,
                        s.alt += " - " + e.description);
                        const r = n("<img>", s);
                        t.append([r, i]),
                        o.append(t)
                    }
                    e.hash && o.attr("data-e-action-hash", e.hash),
                    h.append(o)
                }
                )),
                ...
                l && (this.elements.$footer = this.getSlideshowFooter(),
            ...
            activeKeyDown(e) {
                ...
                if (9 === e.which) {
                    ...
                    t.last().trigger("focus")) : !s && n || (e.preventDefault(),
